...
class Index extends React.Component {
  ...
  constructor(props) {
    ...
    this.roles = ['Developer', 'Tech Lover','Team Player','React.js', 'Next.js','Blockchain Expert','Node.js', 'Ethereum', 'Solidity', 'Hyperledger Fabric','Unreal Engine'];
  }
  ...
  render() {
    ...
    return (
      <BaseLayout className={`cover ${isFlipping ? 'cover-1' : 'cover-0'}`} {...this.props.auth}
                  headerType="index"
                  title="Muhammad Ahmed Saeedi - Portfolio">
              ...
              <Col md="6" className="hero-welcome-wrapper">
                <div className="hero-welcome-text">
                  <h1>
                    ...
                    Welcome to the portfolio website of Muhammad Ahmed Saeedi.
